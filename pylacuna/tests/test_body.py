...
{u'jsonrpc': u'2.0', u'id': 4, u'result': {
    u'status': {
        u'body': {u'waste_stored': 8716, u'energy_capacity': u'21457', u'water_capacity': u'24340', u'needs_surface_refresh': u'0', u'ore_hour': 820, u'building_count': 45, u'empire': {u'is_isolationist': u'1', u'name': u'MikeTwo', u'alignment': u'self', u'id': u'51819'},
                ...
                u'image': u'p38-3',
                u'surface_version': u'279',
                u'food_capacity': u'20743',
                u'waste_capacity': u'27580',
                u'water_hour': u'568',
                u'water': 8000,
                u'neutral_entry': u'29 06 2015 18:18:32 +0000',
                u'x': u'426',
                ...
                u'population': 2240000, u'num_incoming_enemy': u'0', u'energy_stored': 15230, u'name': u'Cloraphorm III', u'num_incoming_own': u'0', u'build_queue_size': 9, u'orbit': u'3', u'ore_stored': 19305, u'propaganda_boost': u'0', u'energy_hour': u'760', u'build_queue_len': 9,
                u'y': u'-256',
                u'water_stored': 9108,
                u'star_id': u'49729'},
...
{u'id': 3,
 u'jsonrpc': u'2.0',
 u'result': {
    u'body': {u'surface_image': u'surface-p38'},
...
GET_BUILDINGS_RESPONSE2 = ast.literal_eval('''
{u'id': 3,
 u'jsonrpc': u'2.0',
 u'result': {
    u'body': {u'surface_image': u'surface-p38'},
...
def mock_api(route, method, params=None):
    if method == 'view':
        ...
        return INDIVIDUAL_BUILDING_VIEW
    if method == 'get_buildings':
        print "MOCK: Returning get buildings response"
        return GET_BUILDINGS_RESPONSE
    print "MOCK: Returning mock"
    return MagicMock()


class testEnhancedBody(unittest.TestCase):
    def setUp(self):
        # Create session mock
    ...
    def test_init_and_print(self):
        enhancedbody.EnhancedBody(self.session_mock, self.mock_body)
        print self.mock_body.mock_calls
        print self.session_mock.mock_calls

    def test_init_and_print_enhanced(self):
        be = enhancedbody.EnhancedBody(self.session_mock, self.mock_body)
        print be

    # def test_body_get_buildings(self):
    #     b = enhancedbody.EnhancedBody(self.session_mock, 1)
    #     self.assertEqual(len(b.buildings), 47)
    #     # BEFORE
    #     # print b.buildings

    #     b.get_buildings()
    #     self.assertEqual(len(b.buildings), 46)
    #     # self.assertEqual(b.buildings[0]['level'], '8')
    #     # AFTER
    #     # print b.buildings

    # def test_enhancedbody_print(self):
    #     be = enhancedbody.EnhancedBody(self.session_mock, 1, cache=MagicMock())
    #     print be

    # def test_enhancedbody_value(self):
    #     session_mock = MagicMock()
    #     session_mock.call_method_with_session_id.return_value = GET_BUILDINGS_RESPONSE
    #     b = body.Body(session_mock, 1)
    #     be = enhancedbody.EnhancedBody.from_body(b)
